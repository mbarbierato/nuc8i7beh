...
DefinitionBlock ("SSDT-APPLE.aml", "SSDT", 2, "Clover", "APPLE", 0x00000000)
{
    ...
    // According to the original Apple ACPI tables for MacMini8,1 there are sub-systems
    // present under Device (LPCB) that the Intel NUC8i7BEH2 firmware does not have natively.
